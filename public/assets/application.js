...
(function() {
  ...
  Dashing.Bitcoin = (function(_super) {
    __extends(Bitcoin, _super);

    function Bitcoin() {
      _ref = Bitcoin.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Bitcoin.prototype.ready = function() {};

    Bitcoin.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Pricing = (function(_super) {
    __extends(Pricing, _super);

    function Pricing() {
      _ref = Pricing.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Pricing.prototype.ready = function() {};

    Pricing.prototype.onData = function(data) {
      var $node;
      $node = $(this.node);
      return $.each(data.crawlers, function(_, _crawler) {
        var $crawler_div, hue, rgb;
        $crawler_div = $node.find('#' + _crawler.name);
        hue = 0.3 - 0.3 * (_crawler.error_rate > 20 ? 20 : _crawler.error_rate) / 20;
        rgb = HSVtoRGB(hue, 0.8, 0.8);
        return _crawler.color = 'background: rgb(' + rgb.r + ',' + rgb.g + ',' + rgb.b + ');';
      });
    };
...
(function() {
  ...
  Dashing.Reload = (function(_super) {
    __extends(Reload, _super);

    function Reload() {
      _ref = Reload.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Reload.prototype.minTimesBetweenReload = 1000 * 5;
    ...
    Reload.prototype.onData = function(data) {
      if (!this.initialized || (Date.now() < (this.lastLoad + this.minTimesBetweenReload))) {
        return console.log("Too soon to reload.  Wait " + ((this.lastLoad + this.minTimesBetweenReload - Date.now()) / 1000) + " seconds.");
      } else if (data.url) {
...
(function() {
  var hslToRgb, interpolate, isString, parseColor, parseRgbaColor, rgbToColor, rgbToHsl, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Dashing.Rickshawgraph = (function(_super) {
    ...
    function Rickshawgraph() {
      _ref = Rickshawgraph.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    Rickshawgraph.accessor('current', function() {
      var answer, data, index, point, s, series, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _o, _ref1, _ref2, _ref3, _ref4, _ref5;
      answer = null;
          ...
          switch (this.get('summaryMethod')) {
            ...
            case "highest":
              ...
              if (this.get('unstack') || (this.getRenderer() === "line")) {
                ...
                for (index = _n = 0, _ref3 = series[0].data.length; 0 <= _ref3 ? _n < _ref3 : _n > _ref3; index = 0 <= _ref3 ? ++_n : --_n) {
                  value = 0;
                  for (_o = 0, _len5 = series.length; _o < _len5; _o++) {
                    s = series[_o];
                    value += ((_ref4 = s.data[index]) != null ? _ref4.y : void 0) || 0;
                  }
            ...
            case "none":
              ...
              break;
            default:
              if (series.length === 1 && ((_ref5 = series[0].data) != null ? _ref5.length : void 0) > 0) {
                data = series[0].data;
    ...
    Rickshawgraph.prototype.onData = function(data) {
      var index, needClear, series, subseries, _i, _j, _len, _len1, _ref1, _ref2;
      ...
      if (this.graph) {
        ...
        if (this.get("legend")) {
          for (index = _i = 0, _len = series.length; _i < _len; index = ++_i) {
            ...
            needClear |= ((_ref1 = this.graph.series[index]) != null ? _ref1.name : void 0) !== ((_ref2 = series[index]) != null ? _ref2.name : void 0);
          }
        }
        if (needClear) {
          this.graph = this._createGraph();
    ...
    Rickshawgraph.prototype._createGraph = function() {
      var $container, $graph, $node, err, graph, graphOptions, height, legend, nullsFound, point, s, series, width, xAxisOptions, x_axis, y_axis, _i, _j, _len, _len1, _ref1;
      $node = $(this.node);
    ...
    Rickshawgraph.prototype._updateColors = function(series) {
      var index, subseries, _i, _len, _ref1, _ref2, _ref3, _results;
      if (!this.defaultColors || ((_ref1 = this.defaultColors) != null ? _ref1.length : void 0) !== series.length) {
      ...
      for (index = _i = 0, _len = series.length; _i < _len; index = ++_i) {
        ...
        if (subseries.color == null) {
          subseries.color = ((_ref2 = this.assignedColors) != null ? _ref2[index] : void 0) || this.defaultColors[index];
        }
        _results.push(subseries.stroke != null ? subseries.stroke : subseries.stroke = ((_ref3 = this.strokeColors) != null ? _ref3[index] : void 0) || "#000");
      }
      return _results;
    };
    ...
    computeDefaultColors = function(self, node, series) {
      var alpha, backgroundColor, defaultColors, hsl, hue, hueOffset, hues, index, luminance, luminanceSource, luminances, saturation, saturationSource, saturations, _i, _j, _k, _len, _ref1, _ref2, _ref3;
      defaultColors = [];
      ...
      if ((_ref1 = self.get('colorScheme')) === 'rainbow' || _ref1 === 'near-rainbow') {
        ...
        for (index = _j = 0, _ref2 = series.length; 0 <= _ref2 ? _j < _ref2 : _j > _ref2; index = 0 <= _ref2 ? ++_j : --_j) {
        ...
        for (index = _k = 0, _ref3 = series.length; 0 <= _ref3 ? _k < _ref3 : _k > _ref3; index = 0 <= _ref3 ? ++_k : --_k) {
  ...
  rgbToHsl = function(rgba) {
    var a, b, d, g, h, l, max, min, r, s, _ref1;
...
(function() {
  ...
  Dashing.server_status = (function(_super) {
    __extends(server_status, _super);

    function server_status() {
      _ref = server_status.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    server_status.prototype.ready = function() {};

    server_status.prototype.onData = function(data) {};
