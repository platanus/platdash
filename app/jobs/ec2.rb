...
Dashing.scheduler.every '10m', :first_in => 0 do |job|
    cpu_usage = [
        ...
        {name: 'kwan', instance_id: "i-33fcbd62", region: 'us-east-1'},
        {name: 'guinness', instance_id: "i-4d1b212a", region: 'us-east-1'},
        {name: 'quehambre', instance_id: "i-c8e8a9ac", region: 'us-east-1'},
        {name: 'corona', instance_id: "i-47e7fd22", region: 'us-east-1'}
    ]
    ...
    puts cpu_series
    Dashing.send_event "ec2-cpu", { series: cpu_series }
